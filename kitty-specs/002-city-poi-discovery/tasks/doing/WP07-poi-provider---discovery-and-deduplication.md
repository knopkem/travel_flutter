...
# Work Package Prompt: WP07 – POI Provider - Discovery & Deduplication
...
**Independent Test**: Select Paris; verify progressive loading (Wikipedia first ~2s, then Overpass+Wikidata ~5s), duplicates removed (e.g. Eiffel Tower from 3 sources appears once), UI updates incrementally
...
**Reference**: See [tasks.md](../tasks.md) for detailed subtask descriptions (T044, T045, T046, T047, T048, T049, T050, T051, T052, T053).
