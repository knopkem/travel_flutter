...
# Work Package Prompt: WP08 – User Story 1 - City POI Discovery UI
...
**Goal**: Implement UI screens/widgets for viewing active city with full Wikipedia content and automatically discovered POI list

**Independent Test**: Search for Tokyo, select it; verify city details shows full Wikipedia article, POI list appears below with loading indicators, smooth scrolling
...
**Reference**: See [tasks.md](../tasks.md) for detailed subtask descriptions (T054, T055, T056, T057, T058, T059, T060, T061).
